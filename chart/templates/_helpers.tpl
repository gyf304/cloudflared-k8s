...
*/}}
{{- define "cloudflared.clusterRoleName" -}}
{{- if .Values.clusterRole.create }}
{{- default (include "cloudflared.fullname" .) .Values.clusterRole.name }}
{{- else }}
...
Create the name of the cluster role to use
*/}}
{{- define "cloudflared.clusterRoleBindingName" -}}
{{- if .Values.clusterRoleBinding.create }}
{{- default (include "cloudflared.fullname" .) .Values.clusterRoleBinding.name }}
{{- else }}
